...
export default function ShareButton({ slug, title }: { slug: string; title: string }) {
  ...
  return (
    <button onClick={handleShare}
      className="w-full mt-3 bg-[#FCBC2A] text-[#092040] font-bold py-4 flex flex-row items-center justify-center gap-2 hover:opacity-90 transition-opacity whitespace-nowrap">
