...
export default function LoadingIndicator() {
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <img src="/Logo.svg" alt="BEE log" className="h-16 w-auto animate-pulse motion-reduce:animate-none" />
      <div className="w-48 h-1.5 bg-[#092040]/20 rounded-full overflow-hidden">
        <div className="h-full bg-[#FCBC2A] rounded-full animate-loading-bar motion-reduce:animate-none" />
      </div>
